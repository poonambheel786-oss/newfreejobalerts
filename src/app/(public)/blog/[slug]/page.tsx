          ...
          <article className="lg:col-span-8 bg-surface-container-lowest border border-outline-variant/20 rounded-3xl p-6 md:p-10 space-y-6 shadow-sm">
            ...
            <div className="pt-6 border-t border-slate-100 flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                <a
                  href={`https://www.facebook.com/sharer/sharer.php?u=https://www.newfreejobalerts.com/blog/${post.slug}`}
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a
                  href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(post.title)}&url=https://www.newfreejobalerts.com/blog/${post.slug}`}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2 rounded-lg bg-slate-50 text-slate-500 hover:bg-slate-100 hover:text-primary transition-colors cursor-pointer"
